    ...
    >
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <Link href="/">
            <h1 className="font-heading text-xl sm:text-2xl md:text-4xl tracking-tight uppercase">
              Decornish
            </h1>
          </Link>
        </div>
        ...
        <div className="flex-1 flex items-center justify-end gap-2 sm:gap-4 md:gap-6">
          ...
          >
            ...
            <svg 
              ...
              viewBox="0 0 24 24" 
              fill="currentColor"
              className="w-4 h-4 sm:w-[22px] sm:h-[22px] text-brand-text group-hover:text-[#25D366] transition-colors relative z-10"
            >
